...
const WordContainer: React.FC<Props> = (props) => {
  return (
    <div className="max-h-32 overflow-hidden border-primary border-4 p-3 lg:p-4 leading-9 md:leading-[3rem] rounded-md">
      <span
        className={`font-medium text-2xl md:text-3xl lg:text-4xl ${
          props.isInputCorrect ? "bg-primary/50" : "bg-red-500"
